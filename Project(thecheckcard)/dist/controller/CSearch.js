...
var _require2 = require('sequelize'),
  Op = _require2.Op; // Sequelize의 Op 객체 가져오기
exports.getCardDetails = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var query, condition, cards;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          query = req.query.query; // 검색어 받기
          condition = {}; // 검색어에 따라 조건 설정
          if (query === "교통") {
            ...
            condition.card_name = _defineProperty({}, Op.like, "%".concat(query, "%"));
        ...
        case 6:
          cards = _context.sent;
          console.log("\uAC80\uC0C9\uB41C \uCE74\uB4DC \uC218: ".concat(cards.length));
          res.render('search', {
            cards: cards
          });
          _context.next = 15;
