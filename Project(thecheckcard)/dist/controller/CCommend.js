...
// 모델에서 혜택 top3 조회 함수
var getTop3Cards = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(category) {
    var rankingColumn, cards, _iterator, _step, card, comments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // 카테고리 이름 + '_ranking' > 카드모델에서 지정된 랭킹 관련 컬럼명 규칙!
          rankingColumn = "".concat(category, "_ranking");
          _context.next = 3;
          return db.Card.findAll({
            where: _defineProperty({}, rankingColumn, _defineProperty({}, db.Sequelize.Op.not, null)),
            // top3 가져오기!
        ...
        case 7:
          ...
          return db.Comment.findAll({
            ...
            order: [[db.Sequelize.literal('likeCount'), 'DESC'], ['createdAt', 'DESC']],
            limit: 2
          });
        case 11:
  ...
  return function getTop3Cards(_x) {
    return _ref.apply(this, arguments);
  };
}();
// 가져온 혜택 top3 -> commend.ejs 전달
var showTop3Cards = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          console.error('Error fetching cards:', _context2.t0);
  ...
  return function showTop3Cards(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
module.exports = {
  showTop3Cards: showTop3Cards
};