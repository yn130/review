...
module.exports = function (sequelize, DataTypes) {
  ...
  User.addHook('beforeValidate', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(user, options) {
      var existingUserid, existingNickname;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            existingNickname = _context.sent;
